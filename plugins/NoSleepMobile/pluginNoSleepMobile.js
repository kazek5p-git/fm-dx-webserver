...
setupTapEffect();
    ...
    function updateNoSleepA11yState() {
        if (!toggleEl) return;
        toggleEl.setAttribute('aria-pressed', String(wakeLockEnabled));
        toggleEl.setAttribute('aria-label', wakeLockEnabled ? 'Disable screen wake lock' : 'Enable screen wake lock');
    }

    if (toggleEl) {
        toggleEl.setAttribute('role', 'button');
        updateNoSleepA11yState();
    }
